 ...
 * The analyze hand function needs to change the straight, flush, four, three, and  *
...
void analyze_hand(int num_in_rank[NUM_RANKS], int num_in_suit[NUM_SUITS], bool *straight, bool *flush,
